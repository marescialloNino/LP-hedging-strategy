...
from .utils_online import *

from .motherfeeder import MotherFeeder

from .bitgetfeed import BitgetMarket
...
class BrokerHandler:
    ...
    @staticmethod
    def build_end_point(market, account='') -> MotherFeeder:
        if market == 'bitget':
            end_point = BitgetMarket(account='', request_timeout=60000)
        return end_point
